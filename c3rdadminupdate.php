...
<form action="c3rdadminupdate.php" name="f1" method=post>
<br><br><br><br>
<center>
...
<input type="button" class="button button1" value="Update Question Bank " onclick="location.href='c3rdupdatequestion.php'" ><br>
...
<td><input type="button" class="button button2" value="Exit" onclick="location.href='c3rdadminhomepage.php' "  ></td>
