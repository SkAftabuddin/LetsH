...
<form action="c1stadminhomepage.php" method="post">
<br>
<hr><center>
<h3 style="background-color: purple;color: white;">Administrator 1st year CSE Homepage</h3></center><hr>
<br><center>
<table style="border=1"  cellpadding="5" cellspacing="5">
<tr>
<td><input type="button" class="button button1" value="Update" onclick="location.href='c1stadminupdate.php'"><br>

<input type="button" class="button button1" value="Settings" onclick="location.href='c1stsettings.php'"><br>
<input type="button" class="button button1" value="Publish Result" onclick="location.href='c1stupdateresult.php'"></td>
<br>
</tr>
</table><br>
<br>
