...
<title>Admin EEE page</title>
</head>
<body oncontextmenu="return false;">
<form action="adminEEEpage.php" method="post">
...
<center><br>
	...
	<h3 style="background-color:#444;purple;color:white;">Electrical & Electronics Engineering</h3>
	<hr>
	<br>
	<table style="border=1" width="50%"  cellpadding="5" cellspacing="5">
		...
		<tr >
			...
			<option value="e1stadminhomepage.php">1st year</option>
			<option value="e2ndadminhomepage.php">2nd year</option>
			<option value="e3rdadminhomepage.php">3rd year</option>
			<option value="e4thadminhomepage.php">4th year</option></select>
        </th></tr></table><br><br><br><br><br>
</center><hr>
<br><br><center>
