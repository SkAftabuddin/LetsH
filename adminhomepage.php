...
width:100%;color:white;opacity: 0.9;
}
.button1:hover{
...
<br>
<center>
<h3 style="background-color:#444;color: white;opacity: 0.8;">Administrator Homepage</h3></center><hr>
<br><center>
<table style="border=1"  cellpadding="5" cellspacing="5">
<tr>
<td><input type="button" class="button button1" value="Update" onclick="location.href='adminupdate.php'"><br>
	<input type="button" class="button button1" value="Admin User Account" onclick="location.href='adminuseracc.php'"><br>
<input type="button" class="button button1" value="Settings" onclick="location.href='settings.php'"><br>
