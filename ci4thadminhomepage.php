...
<form action="ci4thadminhomepage.php" method="post">
<br>
<hr><center>
<h3 style="background-color: purple;color: white;">Administrator 4th year CIVIL Homepage</h3></center><hr>
<br><center>
<table style="border=1"  cellpadding="5" cellspacing="5">
<tr>
<td><input type="button" class="button button1" value="Update" onclick="location.href='ci4thadminupdate.php'"><br>

<input type="button" class="button button1" value="Settings" onclick="location.href='ci4thsettings.php'"><br>
<input type="button" class="button button1" value="Publish Result" onclick="location.href='ci4thupdateresult.php'"></td>
<br>
</tr>
</table><br>
<br>
