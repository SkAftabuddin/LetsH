...
<form action="c2ndadminhomepage.php" method="post">
<br>
<hr><center>
<h3 style="background-color: purple;color: white;">Administrator 2nd year CSE Homepage</h3></center><hr>
<br><center>
<table style="border=1"  cellpadding="5" cellspacing="5">
<tr>
<td><input type="button" class="button button1" value="Update" onclick="location.href='c2ndadminupdate.php'"><br>

<input type="button" class="button button1" value="Settings" onclick="location.href='c2ndsettings.php'"><br>
<input type="button" class="button button1" value="Publish Result" onclick="location.href='c2ndupdateresult.php'"></td>
<br>
</tr>
</table><br>
<br>
